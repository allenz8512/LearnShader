...
#include "AutoLight.cginc"
            ...
            struct v2f
            {
                ...
                // 把阴影纹理坐标保存到_ShadowCoord:TEXCOORD2，具体坐标类型和光源类型相关
                SHADOW_COORDS(2)
            };
            ...
            v2f vert(a2v v)
            {
                ...
                // 把阴影坐标传给片元着色器，也就是保存到_ShadowCoord
                TRANSFER_SHADOW(o);
                return o;
            }
...
#include "AutoLight.cginc"
    ...
    // Unity内置的着色器包含"LightModel"="ShadowCaster"的Pass，让物体可以正确投射阴影
    Fallback "Specular"
}